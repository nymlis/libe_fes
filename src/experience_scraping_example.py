...
# 2. 変数stock_rowsの確認 確認後下2行をコメントアウト
# print(stock_rows)
# exit()
...
for stock_row in stock_rows:
    ...
    # 3. 変数stock_nameの確認 確認後下2行をコメントアウト
    # print(stock_name)
    # exit()
    ...
    # 1株当たり配当金をスクレイピング
    dividend_per_share = stock_row.select('.P452zeXX')[3].select_one('._3rXWJKZF').get_text()

    # 配当利回りをスクレイピング
    dividend_yield = stock_row.select('.P452zeXX')[4].select_one('._3rXWJKZF').get_text()
